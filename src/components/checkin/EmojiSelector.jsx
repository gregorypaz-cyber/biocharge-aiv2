  ...
  return (
    <div className="space-y-2.5">
      <div className="flex items-center justify-between gap-3">
        ...
        {selectedLabel && (
          <span className="text-support text-primary font-semibold">
            {selectedLabel}
          </span>
        )}
      </div>
        ...
        {emojis.map((emoji, i) => {
          ...
          return (
            ...
            >
              ...
              <span className="text-micro text-muted-foreground leading-tight text-center px-1">
                {labels[i]}
              </span>
            </button>
          );
      ...
      <AnimatePresence mode="wait">
        {selectedInterpretation && (
          <motion.p
            ...
            className="text-support text-muted-foreground mt-1 pl-0.5"
          >
            {selectedInterpretation}
          </motion.p>
        )}
