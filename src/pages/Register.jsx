        ...
        {step === 'register' ? (
          ...
          <form onSubmit={handleVerify} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input value={otp} onChange={e => setOtp(e.target.value)} placeholder="000000" className="bg-card border-border h-11 text-center text-lg tracking-widest font-mono" required />
            </div>
            {error && <p className="text-sm text-destructive">{error}</p>}
            <Button type="submit" disabled={loading} className="w-full h-11 bg-primary text-primary-foreground font-semibold">
