  ...
  switch (phase) {
    ...
    case 'PLANNING':
      return [
        ...
        { id: 'narrative',          action: hasNarrative ? 'show' : 'exclude', priority: 5 },
    ...
    case 'OPTIMAL_LOAD':
      return [
        ...
        { id: 'narrative',          action: hasNarrative ? 'show' : 'exclude', priority: 7 },
    ...
    case 'OVERLOAD': {
      ...
      return [
        ...
        { id: 'narrative',          action: hasNarrative ? 'show' : 'exclude', priority: 8 },
